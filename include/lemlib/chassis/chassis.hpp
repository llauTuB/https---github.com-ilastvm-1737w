...
#include "util/velocity_PID.hpp" // IWYU pragma: keep
#include "ramseteController/cubic_bezier.hpp"
#include "ramseteController/trajectory_generator.hpp"
#include "ramseteController/ramsete_controller.hpp" // IWYU pragma: keep
...
class Chassis {
    public:
        ...
        /**
         * @brief Move the chassis along a path using Ramsete
         *
         * @param path the path generated with CubicBezier
         * @param params struct to simulate named parameters
         * @param async whether the function should be run asynchronously. true by default
         *
         */
         void followBezier(const CubicBezier &path, AdvancedConstraints ramseteParams = {}, bool async = true);
